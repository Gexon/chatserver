...
// принимаем чатик.
pub fn chat(args: &str, auth_token: &i64, name: &[u8], reset_conn: &bool) -> (String, i64, Vec<u8>, bool) {
    ...
    // вынимаем из пришедшей строки токен. vec_msg[0] - токен авторизации, vec_msg[1] - текст сообщения
    let args = args.trim();
